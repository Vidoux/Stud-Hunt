 ...
 */
@WebServlet("/job_research")
public class JobResearchServlet extends HttpServlet {
    ...
    public void doGet( HttpServletRequest request, HttpServletResponse response )	throws ServletException, IOException {
        ...
        this.getServletContext().getRequestDispatcher( "/WEB-INF/job_research.jsp").forward( request, response );
    }
